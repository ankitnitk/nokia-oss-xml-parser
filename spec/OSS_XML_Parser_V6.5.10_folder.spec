...
#
# V6.5.10 "folder" (onedir) build -- same code, same excludes as the onefile
# V6.5.10 spec, but distributed as a folder instead of a single exe.
#
...
#   unpack step is gone.
#
# Distribute the whole dist_v6510_folder\OSS_XML_Parser_v6.5.10 folder (zipped);
# users run OSS_XML_Parser_v6.5.10.exe inside it.
#
...
exe = EXE(
    ...
    version='version_info_v6510.txt',
)
