...
#
# V6.5.9 "folder" (onedir) build -- same code, same excludes as the onefile
# V6.5.9 spec, but distributed as a folder instead of a single exe.
#
...
#   unpack step is gone.
#
# Distribute the whole dist_v659_folder\OSS_XML_Parser_v6.5.9 folder (zipped);
# users run OSS_XML_Parser_v6.5.9.exe inside it.
#
