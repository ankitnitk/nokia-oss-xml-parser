#!/usr/bin/env python3
"""
OSS XML to XLSX Converter  — Version 6.2  (3G Summary Integration)
...
def generate_info_sheet_xml(files_info, class_names):
    ...
    # Row 2: title
    parts.append(f'<row r="{row}">')
    parts.append(_cell_xml(1, row, 'Created with OSS XML Converter  --  V6.2', style=1))
    parts.append('</row>')
    row += 1
...
class ProgressWindow:
    ...
    def __init__(self, parent):
        ...
        self.win.title("OSS XML Parser  V6.2")
...
def main():
    os.system("title Ankit's XML Parser  [V6.2 - 3G Summary]")
    ...
    parser = argparse.ArgumentParser(description='OSS XML -> Excel Converter V6.2 (3G Summary)')
