#!/usr/bin/env python3
"""
OSS XML to XLSX Converter  — Version 5  (Zero Re-Read + Full Parallel Pipeline)
...
Usage (interactive GUI):   python oss_xml_to_xlsx_v5.py
Usage (command-line):      python oss_xml_to_xlsx_v5.py file1.xml.gz file2.gz -o out.xlsx
                           python oss_xml_to_xlsx_v5.py file1.zip --classes BTS,BCF -o out.xlsx
"""
...
def main():
    os.system("title Ankit's XML Parser  [V5 - Zero Re-Read Summary]")
